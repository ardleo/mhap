<div class="content">
	...
	<p>The <strong><a href="<?php echo $BASE; ?>/userref">User Reference</a></strong> is designed to serve as a handbook and programming guide. However, the online documentation at <code><a href="https://github.com/bcosca/fatfree" onclick="window.open(this.href); return false;">https://github.com/bcosca/fatfree</a></code> provides the latest and most comprehensive information about the framework.</p>
	<p>Take a close look at the Fat-Free <strong><a href="<?php echo $BASE; ?>/lib/api">API Documentation</a></strong> for in-depth information about the framework.</p>
	...
	<p><a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=MJSQL8N5LPDAY" target="_blank"><img src="ui/images/donate.png" title="Donate" /></a><a href="https://coinbase.com/checkouts/7986a0da214006256d470f2f8e1a15cf" target="_blank"><img src="ui/images/bitcoin.png" /></a></p>
	<p/>
</div>
